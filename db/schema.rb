...
ActiveRecord::Schema[7.0].define(version: 2026_01_09_110814) do
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.boolean "confirmed"
    t.datetime "reservation_start", precision: nil
    t.datetime "reservation_end", precision: nil
    t.integer "kind"
    t.decimal "price_precision", precision: 3, scale: 2
    t.decimal "commission_rate", precision: 3, scale: 2
    t.decimal "reservation_fee", precision: 4, scale: 2
    ...
    t.integer "max_donations_per_reservation"
  ...
  create_table "items", force: :cascade do |t|
    ...
    t.datetime "checked_out", precision: nil
  ...
  create_table "time_periods", force: :cascade do |t|
    ...
    t.string "kind"
    t.integer "event_id"
    t.datetime "min", precision: nil
    t.datetime "max", precision: nil
