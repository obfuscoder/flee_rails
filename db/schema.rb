...
ActiveRecord::Schema.define(version: 20_141_125_201_632) do
  ...
  add_index 'notifications', %w(event_id seller_id), name: 'index_notifications_on_event_id_and_seller_id', unique: true
  ...
  add_index 'reservations', %w(event_id number), name: 'index_reservations_on_event_id_and_number', unique: true
  add_index 'reservations', %w(event_id seller_id), name: 'index_reservations_on_event_id_and_seller_id', unique: true
  ...
  add_index 'reserved_items', %w(reservation_id item_id), name: 'index_reserved_items_on_reservation_id_and_item_id', unique: true
  add_index 'reserved_items', %w(reservation_id number), name: 'index_reserved_items_on_reservation_id_and_number', unique: true
