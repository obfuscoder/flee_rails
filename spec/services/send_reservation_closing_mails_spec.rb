...
RSpec.describe SendReservationClosingMails do
  ...
  describe '#call' do
    ...
    before { allow(SendReservationClosingJob).to receive :perform_later }
    ...
    it 'sends mails in background' do
      ...
      reservations.each do |reservation|
        expect(SendReservationClosingJob).to have_received(:perform_later).with(reservation)
      end
    end
  end
end
